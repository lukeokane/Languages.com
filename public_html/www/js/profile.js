                ...
                if (newPass == "")
                    ...
                    } else
                    {
                        ...
                        if (isValidPassword(newPass) == false)
                            {
                                $("#alert").append("New password must be at least 8 chars, including a number and an uppercase letter.");
                                isValid = false;
                            } else
                            {
                                if (newPassRepeat != newPass)
                                {
                                    $("#alert").append("New passwords do not match.");
                                    isValid = false;
                                }
                            }
                    }
                            ...
                            success: function (result)
                                {
                                    if (result == 1)
                                        ...
                                        } else
                                        {
                                            $("#alert").removeClass();
                                            $("#alert").empty();
                                            $("#alert").append("Incorrect <b>current password</b>.")
                                            $("#alert").fadeOut();
                                            $("#alert").addClass("alert alert-danger");
                                            $("#alert").fadeIn();
                                        }
